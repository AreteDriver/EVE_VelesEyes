...
All notable changes to EVE Veles Eyes will be documented in this file.
...
### Changed
- Renamed project from "EVE Overview Pro" to "EVE Veles Eyes"
- Updated all configuration paths to use `~/.config/eve-veles-eyes/`
